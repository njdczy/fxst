...
use Closure;
use App\Menber\Exception\Handle;
use App\Menber\Form\Builder;
use App\Menber\Form\Field;
use App\Menber\Form\Field\File;
use App\Menber\Form\Tab;
...
class Form
{
    ...
    public function store()
    {
        ...
        if ($response = $this->ajaxResponse(trans('menber::lang.save_succeeded'))) {
            return $response;
        }
    ...
    {
        menber_toastr(trans('menber::lang.save_succeeded'));
    ...
    public function update($id)
    {
        ...
        if ($this->handleOrderable($id, $data)) {
            return response([
                'status'  => true,
                'message' => trans('menber::lang.update_succeeded'),
            ]);
        }
        ...
        if ($response = $this->ajaxResponse(trans('menber::lang.update_succeeded'))) {
            return $response;
        }
    ...
    {
        $map = [
            'button'            => \App\Menber\Form\Field\Button::class,
            'checkbox'          => \App\Menber\Form\Field\Checkbox::class,
            'color'             => \App\Menber\Form\Field\Color::class,
            'currency'          => \App\Menber\Form\Field\Currency::class,
            'date'              => \App\Menber\Form\Field\Date::class,
            'dateRange'         => \App\Menber\Form\Field\DateRange::class,
            'datetime'          => \App\Menber\Form\Field\Datetime::class,
            'dateTimeRange'     => \App\Menber\Form\Field\DatetimeRange::class,
            'datetimeRange'     => \App\Menber\Form\Field\DatetimeRange::class,
            'decimal'           => \App\Menber\Form\Field\Decimal::class,
            'display'           => \App\Menber\Form\Field\Display::class,
            'divider'           => \App\Menber\Form\Field\Divide::class,
            'divide'            => \App\Menber\Form\Field\Divide::class,
            'embeds'            => \App\Menber\Form\Field\Embeds::class,
            'editor'            => \App\Menber\Form\Field\Editor::class,
            'email'             => \App\Menber\Form\Field\Email::class,
            'file'              => \App\Menber\Form\Field\File::class,
            'hasMany'           => \App\Menber\Form\Field\HasMany::class,
            'hidden'            => \App\Menber\Form\Field\Hidden::class,
            'id'                => \App\Menber\Form\Field\Id::class,
            'image'             => \App\Menber\Form\Field\Image::class,
            'ip'                => \App\Menber\Form\Field\Ip::class,
            'map'               => \App\Menber\Form\Field\Map::class,
            'mobile'            => \App\Menber\Form\Field\Mobile::class,
            'month'             => \App\Menber\Form\Field\Month::class,
            'multipleSelect'    => \App\Menber\Form\Field\MultipleSelect::class,
            'number'            => \App\Menber\Form\Field\Number::class,
            'password'          => \App\Menber\Form\Field\Password::class,
            'radio'             => \App\Menber\Form\Field\Radio::class,
            'rate'              => \App\Menber\Form\Field\Rate::class,
            'select'            => \App\Menber\Form\Field\Select::class,
            'slider'            => \App\Menber\Form\Field\Slider::class,
            'switch'            => \App\Menber\Form\Field\SwitchField::class,
            'text'              => \App\Menber\Form\Field\Text::class,
            'textarea'          => \App\Menber\Form\Field\Textarea::class,
            'time'              => \App\Menber\Form\Field\Time::class,
            'timeRange'         => \App\Menber\Form\Field\TimeRange::class,
            'url'               => \App\Menber\Form\Field\Url::class,
            'year'              => \App\Menber\Form\Field\Year::class,
            'html'              => \App\Menber\Form\Field\Html::class,
            'tags'              => \App\Menber\Form\Field\Tags::class,
            'icon'              => \App\Menber\Form\Field\Icon::class,
            'multipleFile'      => \App\Menber\Form\Field\MultipleFile::class,
            'multipleImage'     => \App\Menber\Form\Field\MultipleImage::class,
            'captcha'           => \App\Menber\Form\Field\Captcha::class,
        ];
