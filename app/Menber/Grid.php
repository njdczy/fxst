...
use App\Menber\Grid\Displayers\Actions;
use App\Menber\Grid\Displayers\RowSelector;
use App\Menber\Grid\Exporter;
use App\Menber\Grid\Filter;
use App\Menber\Grid\Model;
use App\Menber\Grid\Row;
use App\Menber\Grid\Tools;
...
class Grid
{
     ...
     * @var string
     */
    protected $view = 'menber::grid.table';
    ...
    protected function appendActionsColumn()
    {
        ...
        $column = $this->addColumn('__actions__', trans('menber::lang.action'));
    ...
    {
        $map = [
            'editable'      => \App\Menber\Grid\Displayers\Editable::class,
            'switch'        => \App\Menber\Grid\Displayers\SwitchDisplay::class,
            'switchGroup'   => \App\Menber\Grid\Displayers\SwitchGroup::class,
            'select'        => \App\Menber\Grid\Displayers\Select::class,
            'image'         => \App\Menber\Grid\Displayers\Image::class,
            'label'         => \App\Menber\Grid\Displayers\Label::class,
            'button'        => \App\Menber\Grid\Displayers\Button::class,
            'link'          => \App\Menber\Grid\Displayers\Link::class,
            'badge'         => \App\Menber\Grid\Displayers\Badge::class,
            'progressBar'   => \App\Menber\Grid\Displayers\ProgressBar::class,
            'radio'         => \App\Menber\Grid\Displayers\Radio::class,
            'checkbox'      => \App\Menber\Grid\Displayers\Checkbox::class,
            'orderable'     => \App\Menber\Grid\Displayers\Orderable::class,
        ];
