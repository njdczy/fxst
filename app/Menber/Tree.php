...
class Tree implements Renderable
{
    ...
    {
        $confirm = trans('menber::lang.delete_confirm');
        $saveSucceeded = trans('menber::lang.save_succeeded');
        $refreshSucceeded = trans('menber::lang.refresh_succeeded');
        $deleteSucceeded = trans('menber::lang.delete_succeeded');
