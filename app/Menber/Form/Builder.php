...
class Builder
{
    ...
    public function title()
    {
        if ($this->mode == static::MODE_CREATE) {
            return trans('menber::lang.create');
        }

        if ($this->mode == static::MODE_EDIT) {
            return trans('menber::lang.edit');
        }

        if ($this->mode == static::MODE_VIEW) {
            return trans('menber::lang.view');
        }
