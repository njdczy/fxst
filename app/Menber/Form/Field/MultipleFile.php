...
class MultipleFile extends Field
{
    ...
    protected static $css = [
        '/packages/front/bootstrap-fileinput/css/fileinput.min.css?v=4.3.7',
    ];
     ...
     */
    protected static $js = [
        '/packages/front/bootstrap-fileinput/js/plugins/canvas-to-blob.min.js?v=4.3.7',
        '/packages/front/bootstrap-fileinput/js/fileinput.min.js?v=4.3.7',
    ];
    ...
    {
        return config('menber.upload.directory.file');
    }
