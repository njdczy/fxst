...
namespace App\Menber\Grid\Filter;

use App\Menber\Grid\Filter;
use App\Menber\Grid\Filter\Field\DateTime;
use App\Menber\Grid\Filter\Field\Select;
use App\Menber\Grid\Filter\Field\Text;
...
abstract class AbstractFilter
{
    ...
    public function render()
    {
        ...
        $view = 'menber::filter.'.strtolower(end($class));
