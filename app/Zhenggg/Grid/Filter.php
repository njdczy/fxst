...
use App\Zhenggg\Grid\Filter\AbstractFilter;
...
class Filter
{
     ...
     * @var string
     */
    protected $view = 'front::grid.filter';
...
EOT;
    ...
    public function __call($method, $arguments)
    {
        if (in_array($method, $this->supports)) {
            $className = '\\App\\Zhenggg\\Grid\\Filter\\'.ucfirst($method);
