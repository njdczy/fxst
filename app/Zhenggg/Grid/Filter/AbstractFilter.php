...
use App\Zhenggg\Grid\Filter\Field\DateTime;
use App\Zhenggg\Grid\Filter\Field\Select;
use App\Zhenggg\Grid\Filter\Field\Text;
...
abstract class AbstractFilter
{
    ...
    public function render()
    {
        ...
        $view = 'front::filter.'.strtolower(end($class));
