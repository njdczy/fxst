...
use Closure;
use App\Zhenggg\Exception\Handle;
use App\Zhenggg\Form\Builder;
use App\Zhenggg\Form\Field;
use App\Zhenggg\Form\Field\File;
use App\Zhenggg\Form\Tab;
...
class Form
{
    ...
    public function store()
    {
        ...
        if (($response = $this->firstComplete($this->created)) instanceof Response) {
            return $response;
        }

        if ($response = $this->ajaxResponse(trans('front::lang.save_succeeded'))) {
            return $response;
        }
    ...
    {
        front_toastr(trans('front::lang.save_succeeded'));
    ...
    /**
     * Callback after creating a Model.
     *
     * @param Closure|null $callback
     *
     * @return mixed|null
     */
    protected function firstComplete(Closure $callback = null)
    {
        if ($callback instanceof Closure) {
            return $callback($this);
        }
    ...
    /**
     * Callback after deleting a Model.
     *
     * @param Closure|null $callback
     *
     * @return mixed|null
     */
    protected function delComplete(Closure $callback = null)
    {
        if ($callback instanceof Closure) {
            return $callback($this);
        }
    ...
    public function update($id)
    {
        ...
        if ($this->handleOrderable($id, $data)) {
            return response([
                'status'  => true,
                'message' => trans('front::lang.update_succeeded'),
            ]);
        }
        ...
        if ($response = $this->ajaxResponse(trans('front::lang.update_succeeded'))) {
            return $response;
        }
    ...
    {
        $map = [
            'button'            => \App\Zhenggg\Form\Field\Button::class,
            'checkbox'          => \App\Zhenggg\Form\Field\Checkbox::class,
            'color'             => \App\Zhenggg\Form\Field\Color::class,
            'currency'          => \App\Zhenggg\Form\Field\Currency::class,
            'date'              => \App\Zhenggg\Form\Field\Date::class,
            'dateRange'         => \App\Zhenggg\Form\Field\DateRange::class,
            'datetime'          => \App\Zhenggg\Form\Field\Datetime::class,
            'dateTimeRange'     => \App\Zhenggg\Form\Field\DatetimeRange::class,
            'datetimeRange'     => \App\Zhenggg\Form\Field\DatetimeRange::class,
            'decimal'           => \App\Zhenggg\Form\Field\Decimal::class,
            'display'           => \App\Zhenggg\Form\Field\Display::class,
            'divider'           => \App\Zhenggg\Form\Field\Divide::class,
            'divide'            => \App\Zhenggg\Form\Field\Divide::class,
            'embeds'            => \App\Zhenggg\Form\Field\Embeds::class,
            'editor'            => \App\Zhenggg\Form\Field\Editor::class,
            'email'             => \App\Zhenggg\Form\Field\Email::class,
            'file'              => \App\Zhenggg\Form\Field\File::class,
            'hasMany'           => \App\Zhenggg\Form\Field\HasMany::class,
            'hidden'            => \App\Zhenggg\Form\Field\Hidden::class,
            'id'                => \App\Zhenggg\Form\Field\Id::class,
            'image'             => \App\Zhenggg\Form\Field\Image::class,
            'ip'                => \App\Zhenggg\Form\Field\Ip::class,
            'map'               => \App\Zhenggg\Form\Field\Map::class,
            'mobile'            => \App\Zhenggg\Form\Field\Mobile::class,
            'month'             => \App\Zhenggg\Form\Field\Month::class,
            'multipleSelect'    => \App\Zhenggg\Form\Field\MultipleSelect::class,
            'number'            => \App\Zhenggg\Form\Field\Number::class,
            'password'          => \App\Zhenggg\Form\Field\Password::class,
            'radio'             => \App\Zhenggg\Form\Field\Radio::class,
            'rate'              => \App\Zhenggg\Form\Field\Rate::class,
            'select'            => \App\Zhenggg\Form\Field\Select::class,
            'slider'            => \App\Zhenggg\Form\Field\Slider::class,
            'switch'            => \App\Zhenggg\Form\Field\SwitchField::class,
            'text'              => \App\Zhenggg\Form\Field\Text::class,
            'textarea'          => \App\Zhenggg\Form\Field\Textarea::class,
            'time'              => \App\Zhenggg\Form\Field\Time::class,
            'timeRange'         => \App\Zhenggg\Form\Field\TimeRange::class,
            'url'               => \App\Zhenggg\Form\Field\Url::class,
            'year'              => \App\Zhenggg\Form\Field\Year::class,
            'html'              => \App\Zhenggg\Form\Field\Html::class,
            'tags'              => \App\Zhenggg\Form\Field\Tags::class,
            'icon'              => \App\Zhenggg\Form\Field\Icon::class,
            'multipleFile'      => \App\Zhenggg\Form\Field\MultipleFile::class,
            'multipleImage'     => \App\Zhenggg\Form\Field\MultipleImage::class,
            'captcha'           => \App\Zhenggg\Form\Field\Captcha::class,
        ];
