...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Install the front package';
    ...
    public function publishDatabase()
    {
        ...
        $this->call('db:seed', ['--class' => \App\Zhenggg\Auth\Database\AdminTablesSeeder::class]);
    }
    ...
    {
        $this->directory = config('front.directory');
    ...
    public function createHomeController()
    {
        ...
        $this->laravel['files']->put(
            $homeController,
            str_replace('DummyNamespace', Front::controllerNamespace(), $contents)
        );
