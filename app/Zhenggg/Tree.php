...
class Tree implements Renderable
{
    ...
    protected function script()
    {
        ...
        $saveSucceeded = trans('front::lang.save_succeeded');
        $refreshSucceeded = trans('front::lang.refresh_succeeded');
        $deleteSucceeded = trans('front::lang.delete_succeeded');
