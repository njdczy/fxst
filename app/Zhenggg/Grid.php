...
use App\Zhenggg\Grid\Displayers\Actions;
use App\Zhenggg\Grid\Displayers\RowSelector;
use App\Zhenggg\Grid\Exporter;
use App\Zhenggg\Grid\Filter;
use App\Zhenggg\Grid\Model;
use App\Zhenggg\Grid\Row;
use App\Zhenggg\Grid\Tools;
...
class Grid
{
     ...
     * @var string
     */
    protected $view = 'front::grid.table';
    ...
    protected function appendActionsColumn()
    {
        ...
        $column = $this->addColumn('__actions__', trans('front::lang.action'));
    ...
    {
        $map = [
            'editable'      => \App\Zhenggg\Grid\Displayers\Editable::class,
            'switch'        => \App\Zhenggg\Grid\Displayers\SwitchDisplay::class,
            'switchGroup'   => \App\Zhenggg\Grid\Displayers\SwitchGroup::class,
            'select'        => \App\Zhenggg\Grid\Displayers\Select::class,
            'image'         => \App\Zhenggg\Grid\Displayers\Image::class,
            'label'         => \App\Zhenggg\Grid\Displayers\Label::class,
            'button'        => \App\Zhenggg\Grid\Displayers\Button::class,
            'link'          => \App\Zhenggg\Grid\Displayers\Link::class,
            'badge'         => \App\Zhenggg\Grid\Displayers\Badge::class,
            'progressBar'   => \App\Zhenggg\Grid\Displayers\ProgressBar::class,
            'radio'         => \App\Zhenggg\Grid\Displayers\Radio::class,
            'checkbox'      => \App\Zhenggg\Grid\Displayers\Checkbox::class,
            'orderable'     => \App\Zhenggg\Grid\Displayers\Orderable::class,
        ];
