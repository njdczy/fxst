...
use App\Zhenggg\Scaffold\ControllerCreator;
use App\Zhenggg\Scaffold\MigrationCreator;
use App\Zhenggg\Scaffold\ModelCreator;
...
class ScaffoldController extends Controller
{
    public function index()
    {
        return Front::content(function (Content $content) {
            ...
            $content->row(view('Front::helpers.scaffold', compact('dbTypes', 'action')));
        });
    }
