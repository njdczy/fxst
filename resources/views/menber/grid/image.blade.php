            ...
            @foreach($grid->rows() as $row)
                <li>
                    <span class="mailbox-attachment-icon has-img">
                        <img src="{!! isset($server) ? $server : config('menber.upload.host') !!}/{!! $row->column($image_column) !!}" alt="Attachment">
                    </span>
                        ...
                        <span class="mailbox-attachment-size">
                          <input type="checkbox" class="grid-item" data-id="{{ $row->id() }}" />
                            <span class="pull-right">
                                ...
                                <a href="{!! isset($server) ? $server : config('menber.upload.host') !!}/{!! $row->column($image_column) !!}" target="_blank" download="custom-filename.jpg">
