...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset("/packages/front/AdminLTE/dist/css/skins/" . config('menber.skin') .".min.css") }}">
...
<body class="hold-transition {{config('menber.skin')}} {{join(' ', config('menber.layout'))}}">
<div class="wrapper">

    @include('menber::partials.header')

    @include('menber::partials.sidebar')
    ...
    @include('menber::partials.footer')
